...
const ALL_GOODS: GoodsDefinition[] = [
  ...
  { id: 'plate_armor', name: 'Plate Armor', icon: '🏰', basePrice: 200, category: 'armor', tier: 2, description: 'Full plate. Heavy but protective.', craftable: true, materialCost: 110, cooldown: 135 },
  ...
  { id: 'vorpal_sword', name: 'Vorpal Sword', icon: '🔪', basePrice: 2500, category: 'weapon', tier: 6, description: 'Cuts through reality itself.', craftable: true, materialCost: 1350, cooldown: 810 },
  ...
  { id: 'dragon_heart_steak', name: 'Dragon Heart Steak', icon: '🥩', basePrice: 4000, category: 'food', tier: 7, description: 'Grants fire resistance and immense vigor.', craftable: false, materialCost: 2200, cooldown: 660 },
  { id: 'void_pearl', name: 'Void Pearl', icon: '🖤', basePrice: 6500, category: 'trinket', tier: 7, description: 'A pearl from the spaces between worlds.', craftable: false, materialCost: 3550, cooldown: 660 },

  // Tier 8 - Grand Exchange (Forge 1080s / Buy 780s) — ~2 min more than T7
  { id: 'godslayer', name: 'Godslayer', icon: '⚡', basePrice: 15000, category: 'weapon', tier: 8, description: 'The weapon of legends. Fells even immortals.', craftable: true, materialCost: 8200, cooldown: 1080 },
  { id: 'world_aegis', name: 'World Aegis', icon: '🌍', basePrice: 18000, category: 'armor', tier: 8, description: 'Shield that protected the world from oblivion.', craftable: true, materialCost: 9800, cooldown: 1080 },
  ...
  { id: 'feast_of_kings', name: 'Feast of Kings', icon: '🍽️', basePrice: 10000, category: 'food', tier: 8, description: 'A legendary meal that empowers entire armies.', craftable: false, materialCost: 5500, cooldown: 780 },
  { id: 'infinity_gem', name: 'Infinity Gem', icon: '💠', basePrice: 20000, category: 'trinket', tier: 8, description: 'Contains a fragment of infinite power.', craftable: false, materialCost: 11000, cooldown: 780 },
];
